    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 ">
        ...
        >
          ...
          >
            <button className="bg-white dark:bg-gray-700 text-purple-700 dark:text-yellow-300 hover:bg-purple-50 dark:hover:bg-gray-600 hover:text-purple-800 dark:hover:text-yellow-400 px-6 py-3 rounded-lg font-semibold mt-4 transition-all duration-300">
              View Projects
            </button>
          </ScrollLink>
        </motion.div>
